...
{
    [TestFixture]
    public class TakeOperatorTests
    {
        [Test]
        public void Execute_OnTaking_ReturnsFilteredRows()
        {
            // Arrange
            ...
            var op = new TakeOperator(mockSource.Object, 1, 0);
        ...
        [Test]
        public void Execute_OnSkip_ReturnsFilteredRows()
        {
            // Arrange
            var sourceRows = new List<Dictionary<string, object>>
            {
            ...
            var op = new TakeOperator(mockSource.Object, 1, 1);
            ...
            result.Should().NotBeNull();
            result.Rows.Should().HaveCount(1);
            result.Rows.Should().OnlyContain(r => (string)r["City"] == "New York");
        }
    }
}